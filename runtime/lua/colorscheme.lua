...
local function set_indenline_hl()
	...
	vim.api.nvim_set_hl(0, "IndentBlanklineSpaceCharBlankline", { ctermfg = 142, fg = "Grey50", nocombine = true })
	vim.api.nvim_set_hl(0, "IndentBlanklineSpaceChar", { ctermfg = 142, fg = "Grey50", nocombine = true })
	vim.api.nvim_set_hl(0, "IndentBlanklineChar", { ctermfg = 142, fg = "Grey50", nocombine = true })
end
